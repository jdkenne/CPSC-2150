...
public class MortgageGUIView extends JFrame implements ActionListener, IMortgageView {
    ...
    private final JTextArea nameTxt;
    private final JTextArea incomeTxt;
    private final JTextArea debtTxt;
    private final JTextArea creditScoreTxt;
    private final JTextArea houseCostTxt;
    private final JTextArea dpTxt;
    private final JComboBox yearsCb;
    private final JTextArea approvedTxt;
    private final JTextArea rateTxt;
    private final JTextArea paymentTxt;
