...
public class SetupView extends JFrame implements ActionListener {
    ...
    private final JTextArea numRowsTxt;
    private final JTextArea numColsTxt;
    private final JComboBox<Integer> numPlayersCB;
    private final JLabel errorMessageLbl;
    private final JTextArea numWinTxt;
    private SetupController controller;

    public SetupView() {
        submitButton = new JButton("Submit");
        JLabel numRowsLbl = new JLabel("Number of Rows: ");
        numRowsTxt = new JTextArea(1, 10);
        JLabel numColsLbl = new JLabel("Number of Columns: ");
        numColsTxt = new JTextArea(1, 10);
        errorMessageLbl = new JLabel("");
        JLabel numPlayersLbl = new JLabel("Number of Players: ");
        Integer[] players = {2, 3, 4, 5, 6, 7, 8, 9, 10};
        numPlayersCB = new JComboBox<>(players);
        JLabel numWinLbl = new JLabel("Number to win: ");
